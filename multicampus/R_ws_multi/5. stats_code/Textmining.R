...
# 토픽 분석을 위한 패키지 설치
# 스마트 캠퍼스에 올려져 있는 파일
# KoNLP.zip, devtools.zip, sessioninfo.zip, tm.zip
...
setwd("D:/23_Wonil_Teaching/07_Statistical Computing1/Resource/Rwork/Part-II")
...
# (1) 텍스트 파일 가져오기 ('빅데이터'키워드로 페이스북에서 검색한 결과파일)
...
news <- xpathSApply(rootNode, "//div[@class='cont_home']", xmlValue)
news
