# -*- coding: utf-8 -*-
"""
Created on Thu Jan  6 14:35:35 2022
...
iris_x_pca2 = m_pca2.fit_transform(iris_x_sc) # 2차원으로 축소 되었다.
...
## 모델 적용 (KKN : 최근점 이웃) nearest 네이벌 이웃
...
m_knn1.score(test_x1, test_y1)          # 0.9210526315789473 실 데이터로 들어가면 낮아진다.
